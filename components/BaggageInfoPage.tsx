...
import { ArrowLeft, Plane, Train, Ship, Briefcase, Search, Loader, CheckCircle, Info, XCircle, Globe, FileText, CalendarDays, ShieldCheck } from 'lucide-react';

// Renamed from BaggageInfoPageProps to TravelInfoPageProps
interface TravelInfoPageProps {
  onBack: () => void;
}

type Mode = 'menu' | 'baggage' | 'country';
